...
/**
 * Estrutura que guarda um elemento de um vetor. Cada elemento cont�m uma string e uma prioridade (inteiro)
 */
typedef struct {
	int prioridade;
	char * valor;
 ...
 */
typedef struct {
	/* este campo diz o numero de elementos correntemente no vetor */
	int tamanho;
...
/**
 * variavel global (inicializada em vetor.c) que contabiliza o numero de vezes
 * que maior_que e' chamado
 */
...
/**
 * esta funcao retorna 1 caso o elemento e1 tenha prioridade maior
 * que e2 ou 0 em qualquer dos outros casos (igual ou menor)
 */
int maior_que(elemento * e1, elemento * e2);

/**
 * esta funcao retorna 1 caso o elemento e1 tenha um valor "alfabeticamente
 * superior" e2 ou 0 em qualquer dos outros casos (igual ou menor)
 */
