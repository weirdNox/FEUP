...
/**
*  ordena um vetor por ordem alfabetica recorrendo ao algoritomo insertion sort
*  parametro: vec apontador para vetor
...
/**
*  ordena um vetor por ordem alfabetica recorrendo ao algoritomo selection sort
*  parametro: vec apontador para vetor
*  retorno: -1 se ocorrer um erro ou 0 se for bem sucedido
*/
...
/**
*  ordena um vetor por ordem alfabetica recorrendo ao algoritomo quick sort
*  parametro: vec apontador para vetor
*  retorno: -1 se ocorrer um erro ou 0 se for bem sucedido
*/
...
/**
*  ordena um vetor por ordem alfabetica recorrendo ao algoritomo quick sort melhorado
*  parametro: vec apontador para vetor
*  retorno: -1 se ocorrer um erro ou 0 se for bem sucedido
*/
...
/**
*  le o conteudo do ficheiro de texto com nome para um vetor
